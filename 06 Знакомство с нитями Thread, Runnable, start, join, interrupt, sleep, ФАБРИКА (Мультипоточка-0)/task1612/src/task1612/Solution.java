...
public class Solution {
    ...
    public static class Stopwatch extends Thread {
        ...
        private void doStep() throws InterruptedException { /**4. Метод doStep должен учитывать скорость бегуна.
...
//            Thread.sleep(1000 / owner.getSpeed());
    ...
    public static class Runner {
        Stopwatch stopwatch;
        private String name;
        private int speed;  //2. Поле speed класса Runner должно иметь тип int.

        public Runner(String name, int speed) { //3. Конструктор класса Runner должен принимать String и int.
            this.name = name;
            this.speed = speed;
        ...
        public int getSpeed() { //1. Метод getSpeed должен возвращать int.
            return speed;
        }
